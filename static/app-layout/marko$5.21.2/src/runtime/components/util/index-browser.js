$_mod.def("/marko$5.21.2/src/runtime/components/util/index-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$5.21.2/src/runtime/components/dom-data'/*"../dom-data"*/);
