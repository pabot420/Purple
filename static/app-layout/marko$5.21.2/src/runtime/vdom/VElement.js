$_mod.def("/marko$5.21.2/src/runtime/vdom/VElement", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */

var domData = require('/marko$5.21.2/src/runtime/components/dom-data'/*"../components/dom-data"*/);
var componentsUtil = require('/marko$5.21.2/src/runtime/components/util/index-browser'/*"../components/util"*/);
var vElementByDOMNode = domData.___vElementByDOMNode;
var VNode = require('/marko$5.21.2/src/runtime/vdom/VNode'/*"./VNode"*/);
